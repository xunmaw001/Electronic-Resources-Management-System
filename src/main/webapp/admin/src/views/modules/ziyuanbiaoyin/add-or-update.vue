<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="书号" prop="shuhao">
          <el-input v-model="ruleForm.shuhao" 
              placeholder="书号" clearable  :readonly="ro.shuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="书号" prop="shuhao">
              <el-input v-model="ruleForm.shuhao" 
                placeholder="书号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="书名" prop="shuming">
          <el-input v-model="ruleForm.shuming" 
              placeholder="书名" clearable  :readonly="ro.shuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="书名" prop="shuming">
              <el-input v-model="ruleForm.shuming" 
                placeholder="书名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="其他责任者" prop="qitazerenzhe">
          <el-input v-model="ruleForm.qitazerenzhe" 
              placeholder="其他责任者" clearable  :readonly="ro.qitazerenzhe"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="其他责任者" prop="qitazerenzhe">
              <el-input v-model="ruleForm.qitazerenzhe" 
                placeholder="其他责任者" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="版次" prop="banci">
          <el-input v-model="ruleForm.banci" 
              placeholder="版次" clearable  :readonly="ro.banci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="版次" prop="banci">
              <el-input v-model="ruleForm.banci" 
                placeholder="版次" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出版时间" prop="chubanshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chubanshijian" label="出版时间" prop="chubanshijian">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="页数" prop="yeshu">
          <el-input v-model="ruleForm.yeshu" 
              placeholder="页数" clearable  :readonly="ro.yeshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="页数" prop="yeshu">
              <el-input v-model="ruleForm.yeshu" 
                placeholder="页数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="关键字" prop="guanjianzi">
          <el-input v-model="ruleForm.guanjianzi" 
              placeholder="关键字" clearable  :readonly="ro.guanjianzi"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="摘要" prop="zhaiyao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhaiyao" label="摘要" prop="zhaiyao">
                    <span v-html="ruleForm.zhaiyao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.chubanshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='shuhao'){
            this.ruleForm.shuhao = obj[o];
	    this.ro.shuhao = true;
            continue;
          }
          if(o=='shuming'){
            this.ruleForm.shuming = obj[o];
	    this.ro.shuming = true;
            continue;
          }
          if(o=='zuozhe'){
	    ...
	    this.ro.zuozhe = true;
          ...
          if(o=='qitazerenzhe'){
            this.ruleForm.qitazerenzhe = obj[o];
	    this.ro.qitazerenzhe = true;
            continue;
          }
          if(o=='chubanshe'){
	...
	this.ruleForm.zhaiyao = this.ruleForm.zhaiyao.replace(reg,'../../../ssm602nm/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ziyuanbiaoyin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.ziyuanbiaoyinCrossAddOrUpdateFlag = false;
						 this.parent.search();
