<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="数据库编号" prop="shujukubianhao">
          <el-input v-model="ruleForm.shujukubianhao" 
              placeholder="数据库编号" clearable  :readonly="ro.shujukubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="数据库编号" prop="shujukubianhao">
              <el-input v-model="ruleForm.shujukubianhao" 
                placeholder="数据库编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wenjianmingcheng = true;
          ...
          if(o=='shujukubianhao'){
            this.ruleForm.shujukubianhao = obj[o];
	    this.ro.shujukubianhao = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ziyuanliebiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.ziyuanliebiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
