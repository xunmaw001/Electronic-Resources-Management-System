<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="数据库编码" prop="shujukubianma">
          <el-input v-model="ruleForm.shujukubianma" 
              placeholder="数据库编码" clearable  :readonly="ro.shujukubianma"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="数据库编码" prop="shujukubianma">
              <el-input v-model="ruleForm.shujukubianma" 
                placeholder="数据库编码" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="数据库名称" prop="shujukumingcheng">
          <el-input v-model="ruleForm.shujukumingcheng" 
              placeholder="数据库名称" clearable  :readonly="ro.shujukumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="数据库名称" prop="shujukumingcheng">
              <el-input v-model="ruleForm.shujukumingcheng" 
                placeholder="数据库名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="创建时间" prop="chuangjianshijian">
          <el-input v-model="ruleForm.chuangjianshijian" 
              placeholder="创建时间" clearable  :readonly="ro.chuangjianshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="创建时间" prop="chuangjianshijian">
              <el-input v-model="ruleForm.chuangjianshijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分类方法" prop="fenleifangfa">
          <el-input v-model="ruleForm.fenleifangfa" 
              placeholder="分类方法" clearable  :readonly="ro.fenleifangfa"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分类方法" prop="fenleifangfa">
              <el-input v-model="ruleForm.fenleifangfa" 
                placeholder="分类方法" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='shujukubianma'){
            this.ruleForm.shujukubianma = obj[o];
	    this.ro.shujukubianma = true;
            continue;
          }
          if(o=='shujukumingcheng'){
            this.ruleForm.shujukumingcheng = obj[o];
	    this.ro.shujukumingcheng = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	    ...
	    this.ro.chuangjianshijian = true;
          ...
          if(o=='fenleifangfa'){
            this.ruleForm.fenleifangfa = obj[o];
	    this.ro.fenleifangfa = true;
            continue;
          }
          if(o=='shuliang'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shujuku/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shujukuCrossAddOrUpdateFlag = false;
						 this.parent.search();
