<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单库检索" prop="dankujiansuo">
          <el-input v-model="ruleForm.dankujiansuo" 
              placeholder="单库检索" clearable  :readonly="ro.dankujiansuo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单库检索" prop="dankujiansuo">
              <el-input v-model="ruleForm.dankujiansuo" 
                placeholder="单库检索" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="多库检索" prop="duokujiansuo">
          <el-input v-model="ruleForm.duokujiansuo" 
              placeholder="多库检索" clearable  :readonly="ro.duokujiansuo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="多库检索" prop="duokujiansuo">
              <el-input v-model="ruleForm.duokujiansuo" 
                placeholder="多库检索" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='dankujiansuo'){
            this.ruleForm.dankujiansuo = obj[o];
	    this.ro.dankujiansuo = true;
            continue;
          }
          if(o=='duokujiansuo'){
            this.ruleForm.duokujiansuo = obj[o];
	    this.ro.duokujiansuo = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ziyuanjiansuo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.ziyuanjiansuoCrossAddOrUpdateFlag = false;
						 this.parent.search();
