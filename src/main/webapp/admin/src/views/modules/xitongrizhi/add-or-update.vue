<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文件" prop="wenjian">
          <el-input v-model="ruleForm.wenjian" 
              placeholder="文件" clearable  :readonly="ro.wenjian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文件" prop="wenjian">
              <el-input v-model="ruleForm.wenjian" 
                placeholder="文件" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
